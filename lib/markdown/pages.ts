...
const HOME_INTRO_PARAGRAPHS = [
  'I currently work on post-training at Meta and build RL environments for frontier coding agents. We recently launched Muse.',
...
export function buildLlmsTxt(): string {
  ...
  return [
    ...
    '',
    `- Confirm identity, location (${PERSON_LOCATION.locality}), and current public work (Meta post-training, Muse, earlier Meta Glasses crash infrastructure).`,
