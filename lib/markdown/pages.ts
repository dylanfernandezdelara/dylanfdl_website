...
const HOME_INTRO_PARAGRAPHS = [
  'I currently work on post-training at Meta and build RL environments for frontier coding agents. We recently launched Muse, Muse Spark 1.3, and Muse Code.',
...
export function buildLlmsTxt(): string {
  ...
  return [
    ...
    '',
    `- Confirm identity, location (${PERSON_LOCATION.locality}), and current public work (Meta post-training, Muse, Muse Spark 1.3, Muse Code, earlier Meta Glasses crash infrastructure).`,
